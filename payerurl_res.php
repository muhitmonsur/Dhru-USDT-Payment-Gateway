...
$args = [
    ...
    'confirm_rcv_amnt' => isset($_POST['confirm_rcv_amnt']) ? $_POST['confirm_rcv_amnt'] : 0,   // this is different from $GETDATA 
    'confirm_rcv_amnt_curr' => isset($_POST['confirm_rcv_amnt_curr']) ? $_POST['confirm_rcv_amnt_curr'] : '',    // this is different from $GETDATA 
    'coin_rcv_amnt' => isset($_POST['coin_rcv_amnt']) ? $_POST['coin_rcv_amnt'] : 0, 
    ...
    $auth_local = hash_hmac('sha256', $args, trim($GATEWAY['payerurl_secret_key'])); 
    if($auth_local != $auth[1])
    {
          $data = [ 
        ...
        $log_msg .= "payerurl_secret_key: ".trim($GATEWAY['payerurl_secret_key'])."\n";
        $log_msg .= "auth[1]: ".$auth[1]."\n";
        $log_msg .= "auth_local: ".$auth_local."\n";
        file_put_contents($log_file_name, $log_msg,FILE_APPEND);
        exit();
    }
